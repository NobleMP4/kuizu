            ...
            <div class="header-content">
                ...
                <div class="user-menu" style="position: relative;">
                    ...
                    <div class="burger-dropdown" id="burgerDropdown" 
                        ...
                        <a href="dashboard.php" style="display: block; padding: 0.75rem 1rem; color: #374151; text-decoration: none; border-bottom: 1px solid #e5e7eb; cursor: pointer;" onmouseover="this.style.background='#f3f4f6'" onmouseout="this.style.background='white'">🏠 Tableau de bord</a>
                        <a href="join_session.php" style="display: block; padding: 0.75rem 1rem; color: #374151; text-decoration: none; border-bottom: 1px solid #e5e7eb; cursor: pointer;" onmouseover="this.style.background='#f3f4f6'" onmouseout="this.style.background='white'">🎮 Rejoindre une session</a>
                        <a href="history.php" class="active" style="display: block; padding: 0.75rem 1rem; color: white; background: #224d71; text-decoration: none;">📊 Mon historique</a>
                    </div>
